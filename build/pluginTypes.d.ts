import gql, { GraphQLType, GraphQLInputObjectType } from 'graphql';
...
export interface Build {
    ...
    newWithHooks: (Class: any, spec: any, scope: any, performNonEmptyFieldsCheck?: boolean) => any;
...
export { PgClass, PgAttribute, omit, SQL, Plugin, SchemaBuilder, GraphQLType, GraphQLInputObjectType };
